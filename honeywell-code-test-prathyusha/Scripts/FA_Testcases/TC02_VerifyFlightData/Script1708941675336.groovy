...
WebUI.doubleClick(findTestObject('FlightAware/FA_FlightSummary_Label_AircaftDetails'))

WebUI.takeFullPageScreenshot()

WebUI.doubleClick(findTestObject('FlightAware/FA_FlightSummary_Label_FlightData'))
